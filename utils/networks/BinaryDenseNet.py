...
class ConvBlock(tf.keras.layers.Layer):
    ...
    def __init__(self, num_channels):
        ...
        self.ste_sign = larq.quantizers.SteSign()
        self.scale_beta = LearnedRescaleLayer()
        self.scale_alpha = LearnedRescaleLayer()

        self.bconv = larq.layers.QuantConv2D(filters=num_channels, kernel_size=3, padding='same', use_bias=False,
